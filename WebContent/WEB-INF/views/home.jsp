...
<a href="/event/view?num=${eventlist[0].NUM }"><img class="mySlides" src="/event/eventimg/${eventlist[0].EVENTIMG}" style="width:1200px; height:400px;"></a>
  <a href="/event/view?num=${eventlist[1].NUM }"><img class="mySlides" src="/event/eventimg/${eventlist[1].EVENTIMG}" style="width:1200px;height:400px;"></a>
  <a href="/event/view?num=${eventlist[2].NUM }"><img class="mySlides" src="/event/eventimg/${eventlist[2].EVENTIMG}" style="width:1200px;height:400px;"></a>
  <a href="/event/view?num=${eventlist[3].NUM }"><img class="mySlides" src="/event/eventimg/${eventlist[3].EVENTIMG}" style="width:1200px;height:400px; "></a>
